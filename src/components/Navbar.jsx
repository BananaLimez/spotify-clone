    ...
    <>
        <div className='w-full flex justify-between items-center font-semibold'>
            <div className='flex items-center gap-2'>
                <img onClick={()=>navigate(-1)} src={assets.arrow_left} alt='' className='w-8 bg-black p-2 rounded-2xl cursor-pointer'></img>
                <img onClick={()=>navigate(1)} src={assets.arrow_right} alt='' className='w-8 bg-black p-2 rounded-2xl cursor-pointer'></img>
            </div>
        ...
        <div className='flex items-center gap-2 mt-4'>
            ...
            <p className="bg-black px-4 py-1 rounded-2xl ccrsor-pointer">Music</p>
