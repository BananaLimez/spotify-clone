    ...
    return (
        <div className='w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
            <div className='bg-[#121212] h-[15%] rounded flex flex-col justify-around'>
                <div onClick={()=>navigate('/')} className='flex items-center gap-3 pl-8 cursor-pointer my-4'>
                    <img className='w-6'src={assets.home_icon} alt=''></img>
                    <p className='font-semibold'>Home</p>
                </div>
                <div className='flex items-center gap-3 pl-8 cursor-pointer my-4'>
                    <img className='w-6'src={assets.search_icon} alt=''></img>
                    <p className='font-semibold'>Search</p>
                </div>
            </div>
            <div className='bg-[#121212] h-[85%] rounded margin-top-2'>
